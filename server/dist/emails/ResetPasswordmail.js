...
<head>
  ...
  <title>Reset your HMS password</title>
</head>
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#F8FAFC;border:2px solid #0077B6;border-radius:12px;margin-bottom:10px;">
                <tr>
                  <td style="padding:28px 0;text-align:center;">
                    <a href="${resetTokenUrl}" style="background-color:#0077B6;color:#FFFFFF;padding:12px 32px;border-radius:8px;text-decoration:none;font-weight:700;font-size:15px;">
                      Reset Password
                    </a>
                  </td>
                </tr>
              ...
              <p style="font-size:12px;color:#64748B;margin:0 0 32px;text-align:center;">
                This link expires in <strong style="color:#EF4444;">10 minutes</strong>. Do not share it with anyone.
              </p>
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#FEF2F2;border-left:3px solid #EF4444;border-radius:0 8px 8px 0;">
                <tr>
                  <td style="padding:14px 16px;">
                    <p style="font-size:13px;color:#991B1B;line-height:1.6;margin:0;">
                      <strong style="color:#1E293B;">Didn't request a password reset?</strong>
