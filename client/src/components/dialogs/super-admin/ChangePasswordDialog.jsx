...
function validate(form) {
  ...
  else if (form.newPassword.length < 12) errors.newPassword = 'Platform admin passwords must be at least 12 characters';
    ...
    <>
      <div className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-400">Platform admin passwords require at least 12 characters, mixed case, and a symbol.</p>
        </div>
        <div className="space-y-1">
