...
function AvatarUploadForm({ profile, onOpenChange, onSave }) {
  ...
  const handleSave = () => {
    // In production this would upload the selected file to cloud storage and
    // persist the returned URL. The local preview stands in for that URL here.
    onSave(preview);
    onOpenChange(false);
...
export function UploadDoctorAvatarDialog({ profile, open, onOpenChange, onSave }) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          ...
          <DialogDescription>This photo is visible to staff and patients across the hospital system.</DialogDescription>
        </DialogHeader>
