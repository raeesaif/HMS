import { AlertTriangle, CalendarDays, CheckCircle2, Clock3, FlaskConical, Users } from 'lucide-react';
...
export function DoctorStatsCard({ icon, tone = 'blue', value, title, description }) {
