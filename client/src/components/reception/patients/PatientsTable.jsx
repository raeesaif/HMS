...
const columns = ['Patient ID', 'Patient', 'Age', 'Gender', 'Phone', 'Blood Group', 'Last Visit', 'Status', ''];
      ...
      <Table className="min-w-[920px]">
        ...
        <TableBody>
          {patients.map((patient, index) => (
            <TableRow key={patient.id} className={`border-b-0 hover:bg-transparent ${index % 2 ? 'bg-slate-50/70' : 'bg-white'}`}>
              ...
              <TableCell className="px-4 py-3.5 text-sm text-slate-600">{patient.age}</TableCell>
              <TableCell className="px-4 py-3.5 text-sm text-slate-600">{patient.gender}</TableCell>
              <TableCell className="px-4 py-3.5 text-sm text-slate-600">{patient.phone}</TableCell>
              <TableCell className="px-4 py-3.5 text-sm text-slate-600">{patient.bloodGroup}</TableCell>
              <TableCell className="px-4 py-3.5 text-xs text-slate-500">{patient.lastVisit}</TableCell>
              <TableCell className="px-4 py-3.5">
                <Badge
                  variant="outline"
                  className={
