import { Bell, CalendarDays, CheckCheck, FileText, FlaskConical, MoreVertical, Pill, Receipt, Trash2, Eye } from 'lucide-react';
...
import { notificationTypeMap } from '@/components/patient/statusMaps';
    ...
    >
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem variant="destructive" onClick={() => onAction('delete', notification)}>
            <Trash2 /> Delete
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
